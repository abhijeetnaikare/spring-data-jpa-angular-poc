package com.cailam.springdatajpaangularpoc.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.cailam.springdatajpaangularpoc.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.cailam.springdatajpaangularpoc.model" });
